...
RSpec.describe MigrateDeliveryAttempts do
  it "migrates delivery attempts" do
    ...
    broadcast_with_audio_url = create(:broadcast, audio_url: "https://example.com/test.mp3")

    stub_request(:get, "https://example.com/test.mp3").to_return(status: 200, body: file_fixture("test.mp3"))
    ...
    expect(broadcast_with_audio_url.reload).to have_attributes(
