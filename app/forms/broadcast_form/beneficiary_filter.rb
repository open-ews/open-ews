class BroadcastForm::BeneficiaryFilter
  ...
  attribute :iso_region_code, BroadcastForm::BeneficiaryAddressFilterFieldType.new(field_definition: FieldDefinitions::BeneficiaryFields.find("address.iso_region_code"))
