class BeneficiaryFilterForm < FilterForm
  ...
  attribute :administrative_division_level_2_name, FormType.new(form: FilterFieldForm)
  attribute :administrative_division_level_3_name, FormType.new(form: FilterFieldForm)
  attribute :administrative_division_level_4_name, FormType.new(form: FilterFieldForm)
  attribute :administrative_division_level_5_name, FormType.new(form: FilterFieldForm)
end
